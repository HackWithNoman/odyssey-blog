...
import { SiDribbble, SiTwitch, SiX } from "@icons-pack/react-simple-icons";
...
const Team = () => {
  return (
    <div className="mx-auto flex max-w-(--breakpoint-xl) flex-col justify-center gap-16 px-6 py-8 sm:py-12 lg:px-8 mt-24">
            ...
            <div className="mt-6 flex items-center gap-2.5">
              ...
              >
                <Link href="#" target="_blank">
                  <SiX className="stroke-muted-foreground" />
                </Link>
              </Button>
              <Button
                asChild
              ...
              >
                <Link href="#" target="_blank">
                  <SiDribbble className="stroke-muted-foreground" />
                </Link>
              </Button>
              <Button
                asChild
              ...
              >
                <Link href="#" target="_blank">
                  <SiTwitch className="stroke-muted-foreground" />
                </Link>
              </Button>
            </div>
          </div>
